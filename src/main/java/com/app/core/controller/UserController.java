...
public class UserController {
	...
	@Operation(description = "Get session user endpoint for users", summary = "This is a summary for user get session endpoint")
	@GetMapping(value = "/session")
	public ResponseEntity<GetUserDto> getSessionUser() {
		UserModel user= userService.getSessionUser();
		GetUserDto res = modelMapper.map(user, GetUserDto.class);
	...
	public ResponseEntity<GetUserDto> deleteUser(@PathVariable(name = "id") UUID id) {
